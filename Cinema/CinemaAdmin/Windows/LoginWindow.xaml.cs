                    ...
                    case Scripts.Data.DataBaseManager.Status.OK:
                        {
                            ...
                            {
                                MessageBox.Show($"{Scripts.Account.UserName}, {Languages.Language.SignInNotAdmin}.", "", MessageBoxButton.OK, MessageBoxImage.Information);
                            }                            
                        }
                        break;
